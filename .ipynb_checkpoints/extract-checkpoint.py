...
def extration(dis):
    ...
    data_root = 'D:/午/EXTRACTOR/dataset/0907_(A~F_2)2000samples_10distances' #the folder you want to extract the output vector
    ...
    folder_path = os.path.join('D:/午/EXTRACTOR/RFF/ExpA_0909_TripletLoss_DeepResNet_440E') #output vector saved path
